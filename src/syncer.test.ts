...
test("Syncer.constructor", () => {
  expect(() => new Syncer(config, "some private key")).not.toThrowError();
});

test("Syncer.constructor invalid appID", () => {
  config.appID = null;
  expect(() => new Syncer(config, "some private key")).toThrowError(
    'The configuration\'s "appID" must be set as a number',
  );
});

test("Syncer.constructor invalid logLevel", () => {
  config.logLevel = 123;
  expect(() => new Syncer(config, "some private key")).toThrowError(
    'The configuration\'s optional "logLevel" must be a string',
  );
});

test("Syncer.constructor invalid privateKeyPath type", () => {
  config.privateKeyPath = 123;
  expect(() => new Syncer(config)).toThrowError('The configuration\'s "privateKeyPath" must be a string');
});

test("Syncer.constructor invalid privateKeyPath path", () => {
  config.privateKeyPath = "/this/does/not/exist";
  expect(() => new Syncer(config)).toThrowError(
    'The configuration\'s "privateKeyPath" must be a valid path to a file that exists',
  );
});

test("Syncer.constructor upstreamMappings not set", () => {
  config.upstreamMappings = undefined;
  expect(() => new Syncer(config, "some private key")).toThrowError(
    'The configuration\'s "upstreamMappings" must be a valid object',
  );
});

test("Syncer.constructor upstreamMappings wrong type", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg wrong type", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg.upstreamOrg wrong type", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg.upstreamOrg.branchMappings wrong type", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg.upstreamOrg.branchMappings.upstreamBranch empty string", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg.upstreamOrg.branchMappings.upstreamBranch wrong type", () => {
...
test("Syncer.constructor upstreamMappings.targetOrg.upstreamOrg.branchMappings duplicate target branch", () => {
